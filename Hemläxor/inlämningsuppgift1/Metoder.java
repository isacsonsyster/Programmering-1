...
public class Metoder {
	 ...
	 * @param kelvin is the value in kelvin
	 * @return the value in celcius 
	 */
	...
	/**
	 * the method calculate the pressure for a Fluid in the FluidTable on a certain deep
	 * @param fluid is a fluid from the FluidTable
	 * @param deep is the deep for the pressure, measured in meter
	 * @return the value for the pressure on a certain deep, measured in Pascal ((N/m^2) ((kg*m)/(m^2*s^2)))
	 */
	 ...
	 * @return the value for the water pressure on a certain deep, measured in Pascal ((N/m^2) ((kg*m)/(m^2*s^2)))
	 */
	 ...
	 * @return the delta (difference) between the two numbers, has no unit
	 */
	 ...
	 * @param volume is the volume o the solid we calculate with, measured in cubic centimeter (cm^3) 
	 ...
	 * @param force is the force we use, measured in Newton (kg*m/s^2)
	 ...
	 * @param work is work we use, measured in Newtonmeter (kg*m^2/s^2, Joule)
	 * @param time is how long it takes, measured in seconds
	 * @return the value of power, measured in Watt (kg*m^2)/s^3, Joule per seconds)
	 */
	 ...
	 * @param velocity is how fast it goes, measured in meter per seconds (m/s)
	 * @param time is how long it takes, measured in seconds
	...
	/**
	 * the method calculate the friction with the friction coefficient and normal force
	 ...
	 * @param springCoefficient is the coefficient. This is how "hard" it is to extend it. measured in 	Newton per meter (N/m, kg*m/m*s^2)
	 * @param springExtension is the distance it is extend, measured in meter
	 * @return the value in force, measured in Newton (kg*m/s^2)
	 */
	 ...
	 * @param force is the amount of force you need to extend the spring, measured in Newton (kg*m/s^2)
	 * @param springCoefficient is how hard it is to extend the spring, measured in Newton per meter (N/m, kg*m/m*s^2)
	 * @return
	 */
	 ...
	 * @param mass1 is the mass of the first body (object), measured in kilogram
	 * @param mass2 is the mass of the second body (object), measured in kilogram
	...
	/**
	 * 	the method calculate Newtons gravitation law, but the distance between the two objects. So with force, mass and G
	 * @param mass1 is the mass of the first body (object), measured in kilogram
	 * @param mass2 is the mass of the second body (object), measured in kilogram
	 * @param force is the amount of force there is between the two bodies (objects), measured in Newton (kg*m/s^2)
	 * @return the value in radius (distance between the two  bodies (objects) center, measured in meter
	 */
